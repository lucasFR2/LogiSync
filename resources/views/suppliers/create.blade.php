        ...
        <main class="flex-1">
            ...
            <header class="bg-[#0F172A] shadow-lg px-8 py-4 flex justify-between items-center border-b border-[#1E293B]">
                <h1 class="text-2xl font-bold text-[#FFFFFF]">
                    <i class="fa-solid fa-handshake text-[#2563EB] mr-2"></i>Novo Fornecedor
                </h1>
            ...
            <section class="p-8">
                <div class="max-w-2xl mx-auto">
                    ...
                    <div class="bg-[#0F172A] rounded-lg shadow-lg p-8 border border-[#1E293B]">
                        <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <!-- Nome -->
                                <div class="mb-4">
                                    <label for="name" class="block text-sm font-semibold text-[#FFFFFF] mb-2">
                                    ...
                                    <input 
                                        ...
                                        required
                                        class="w-full px-4 py-2 border border-[#1E293B] bg-[#0F172A] text-[#FFFFFF] placeholder-[#94A3B8] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                                    >
                                </div>

                                <!-- CNPJ -->
                                <div class="mb-4">
                                    <label for="cnpj" class="block text-sm font-semibold text-[#FFFFFF] mb-2">CNPJ</label>
                                    <input 
                                        type="text" 
                                        name="cnpj" 
                                        id="cnpj"
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <!-- Email -->
                                    <div>
                                        <label for="email" class="block text-sm font-semibold text-[#FFFFFF] mb-2">E-mail</label>
                                        <input 
                                            type="email" 
                                            name="email" 
                                            id="email"
                                    ...
                                    <!-- Telefone -->
                                    <div>
                                        <label for="phone" class="block text-sm font-semibold text-[#FFFFFF] mb-2">Telefone</label>
                                        <input 
                                            type="tel" 
                                            name="phone" 
                                            id="phone"
